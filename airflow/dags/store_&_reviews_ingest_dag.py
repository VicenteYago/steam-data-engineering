...
BUCKET_SUBDIR = "lite" # change to raw in prod
BUCKET_SUBDIR_PROC = "proc"

BIGQUERY_DATASET = os.environ.get('GCP_BQ_DATASET')
DATASET_DIR = os.path.join(AIRFLOW_HOME, "dataset/") 

REVIEWS_LOCAL_DIR = os.path.join(AIRFLOW_HOME, "reviews")
REVIEWS_LOCAL_DIR_PROC = os.path.join(AIRFLOW_HOME, "reviews_proc")

CLUSTER_NAME = "cluster-11ee" #"spark-cluster-reviews"
